...
//sampler sampler bg_textureSmpSC 0:23
...
//texture texture2D bg_texture 0:4:0:23
...
//texture texture2DArray bg_textureArrSC 0:35:0:23
...
//spec_const bool bg_textureHasSwappedViews 42 0
...
#define sc_OutputBounds 1
#endif
#ifndef bg_textureHasSwappedViews
#define bg_textureHasSwappedViews 0
#elif bg_textureHasSwappedViews==1
#undef bg_textureHasSwappedViews
#define bg_textureHasSwappedViews 1
#endif
...
#endif
#ifndef bg_textureLayout
#define bg_textureLayout 0
#endif
#ifndef SC_USE_UV_TRANSFORM_bg_texture
#define SC_USE_UV_TRANSFORM_bg_texture 0
#elif SC_USE_UV_TRANSFORM_bg_texture==1
#undef SC_USE_UV_TRANSFORM_bg_texture
#define SC_USE_UV_TRANSFORM_bg_texture 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_bg_texture
#define SC_SOFTWARE_WRAP_MODE_U_bg_texture -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_bg_texture
#define SC_SOFTWARE_WRAP_MODE_V_bg_texture -1
#endif
#ifndef SC_USE_UV_MIN_MAX_bg_texture
#define SC_USE_UV_MIN_MAX_bg_texture 0
#elif SC_USE_UV_MIN_MAX_bg_texture==1
#undef SC_USE_UV_MIN_MAX_bg_texture
#define SC_USE_UV_MIN_MAX_bg_texture 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_bg_texture
#define SC_USE_CLAMP_TO_BORDER_bg_texture 0
#elif SC_USE_CLAMP_TO_BORDER_bg_texture==1
#undef SC_USE_CLAMP_TO_BORDER_bg_texture
#define SC_USE_CLAMP_TO_BORDER_bg_texture 1
#endif
...
uniform vec2 Port_Center_N069;
uniform vec2 Port_Scale_N069;
uniform float slider_value;
uniform float background_alpha;
uniform vec2 Port_Default_N072;
...
uniform mat3 bg_textureTransform;
uniform vec4 bg_textureUvMinMax;
uniform vec4 bg_textureBorderColor;
...
uniform sampler2DArray bg_textureArrSC;
...
int bg_textureGetStereoViewIndex()
{
int l9_0;
#if (bg_textureHasSwappedViews)
{
...
float l9_3=floor(float(is_vertical));
vec2 l9_4;
if (l9_3==0.0)
{
l9_4=((l9_1-Port_Center_N069)*Port_Scale_N069)+Port_Center_N069;
}
else
{
vec2 l9_5;
if (l9_3==1.0)
{
l9_5=vec2((((l9_1-Port_Center_N069)*Port_Scale_N069)+Port_Center_N069).yx);
}
else
{
l9_5=Port_Default_N072;
}
l9_4=l9_5;
}
vec2 l9_6=l9_4+vec2((((slider_value-Port_RangeMinA_N091)/((Port_RangeMaxA_N091-Port_RangeMinA_N091)+1e-06))*(Port_RangeMaxB_N091-Port_RangeMinB_N091))+Port_RangeMinB_N091);
vec4 l9_7;
#if (bg_textureLayout==2)
{
bool l9_8=(int(SC_USE_CLAMP_TO_BORDER_bg_texture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_bg_texture)!=0));
float l9_9=l9_6.x;
sc_SoftwareWrapEarly(l9_9,ivec2(SC_SOFTWARE_WRAP_MODE_U_bg_texture,SC_SOFTWARE_WRAP_MODE_V_bg_texture).x);
float l9_10=l9_9;
float l9_11=l9_6.y;
sc_SoftwareWrapEarly(l9_11,ivec2(SC_SOFTWARE_WRAP_MODE_U_bg_texture,SC_SOFTWARE_WRAP_MODE_V_bg_texture).y);
float l9_12=l9_11;
vec2 l9_13;
float l9_14;
#if (SC_USE_UV_MIN_MAX_bg_texture)
{
bool l9_15;
#if (SC_USE_CLAMP_TO_BORDER_bg_texture)
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_bg_texture,SC_SOFTWARE_WRAP_MODE_V_bg_texture).x==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_bg_texture)!=0);
}
#endif
float l9_16=l9_10;
float l9_17=1.0;
sc_ClampUV(l9_16,bg_textureUvMinMax.x,bg_textureUvMinMax.z,l9_15,l9_17);
float l9_18=l9_16;
float l9_19=l9_17;
bool l9_20;
#if (SC_USE_CLAMP_TO_BORDER_bg_texture)
{
l9_20=ivec2(SC_SOFTWARE_WRAP_MODE_U_bg_texture,SC_SOFTWARE_WRAP_MODE_V_bg_texture).y==3;
}
#else
{
l9_20=(int(SC_USE_CLAMP_TO_BORDER_bg_texture)!=0);
}
#endif
float l9_21=l9_12;
float l9_22=l9_19;
sc_ClampUV(l9_21,bg_textureUvMinMax.y,bg_textureUvMinMax.w,l9_20,l9_22);
l9_14=l9_22;
...
#endif
vec2 l9_23=sc_TransformUV(l9_13,(int(SC_USE_UV_TRANSFORM_bg_texture)!=0),bg_textureTransform);
float l9_24=l9_23.x;
float l9_25=l9_14;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_bg_texture,SC_SOFTWARE_WRAP_MODE_V_bg_texture).x,l9_8,l9_25);
float l9_26=l9_23.y;
float l9_27=l9_25;
sc_SoftwareWrapLate(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_bg_texture,SC_SOFTWARE_WRAP_MODE_V_bg_texture).y,l9_8,l9_27);
float l9_28=l9_27;
vec3 l9_29=sc_SamplingCoordsViewToGlobal(vec2(l9_24,l9_26),bg_textureLayout,bg_textureGetStereoViewIndex());
vec4 l9_30=texture(bg_textureArrSC,l9_29,0.0);
vec4 l9_31;
#if (SC_USE_CLAMP_TO_BORDER_bg_texture)
{
l9_31=mix(bg_textureBorderColor,l9_30,vec4(l9_28));
}
#else
{
l9_31=l9_30;
...
#else
{
bool l9_32=(int(SC_USE_CLAMP_TO_BORDER_bg_texture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_bg_texture)!=0));
float l9_33=l9_6.x;
sc_SoftwareWrapEarly(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_bg_texture,SC_SOFTWARE_WRAP_MODE_V_bg_texture).x);
float l9_34=l9_33;
float l9_35=l9_6.y;
sc_SoftwareWrapEarly(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_bg_texture,SC_SOFTWARE_WRAP_MODE_V_bg_texture).y);
float l9_36=l9_35;
vec2 l9_37;
float l9_38;
#if (SC_USE_UV_MIN_MAX_bg_texture)
...
#if (SC_USE_CLAMP_TO_BORDER_bg_texture)
{
l9_39=ivec2(SC_SOFTWARE_WRAP_MODE_U_bg_texture,SC_SOFTWARE_WRAP_MODE_V_bg_texture).x==3;
}
#else
{
l9_39=(int(SC_USE_CLAMP_TO_BORDER_bg_texture)!=0);
}
#endif
float l9_40=l9_34;
float l9_41=1.0;
sc_ClampUV(l9_40,bg_textureUvMinMax.x,bg_textureUvMinMax.z,l9_39,l9_41);
float l9_42=l9_40;
float l9_43=l9_41;
bool l9_44;
#if (SC_USE_CLAMP_TO_BORDER_bg_texture)
{
l9_44=ivec2(SC_SOFTWARE_WRAP_MODE_U_bg_texture,SC_SOFTWARE_WRAP_MODE_V_bg_texture).y==3;
}
#else
{
l9_44=(int(SC_USE_CLAMP_TO_BORDER_bg_texture)!=0);
}
#endif
float l9_45=l9_36;
float l9_46=l9_43;
sc_ClampUV(l9_45,bg_textureUvMinMax.y,bg_textureUvMinMax.w,l9_44,l9_46);
l9_38=l9_46;
...
#endif
vec2 l9_47=sc_TransformUV(l9_37,(int(SC_USE_UV_TRANSFORM_bg_texture)!=0),bg_textureTransform);
float l9_48=l9_47.x;
float l9_49=l9_38;
sc_SoftwareWrapLate(l9_48,ivec2(SC_SOFTWARE_WRAP_MODE_U_bg_texture,SC_SOFTWARE_WRAP_MODE_V_bg_texture).x,l9_32,l9_49);
float l9_50=l9_47.y;
float l9_51=l9_49;
sc_SoftwareWrapLate(l9_50,ivec2(SC_SOFTWARE_WRAP_MODE_U_bg_texture,SC_SOFTWARE_WRAP_MODE_V_bg_texture).y,l9_32,l9_51);
float l9_52=l9_51;
vec3 l9_53=sc_SamplingCoordsViewToGlobal(vec2(l9_48,l9_50),bg_textureLayout,bg_textureGetStereoViewIndex());
vec4 l9_54=texture(bg_texture,l9_53.xy,0.0);
vec4 l9_55;
#if (SC_USE_CLAMP_TO_BORDER_bg_texture)
{
l9_55=mix(bg_textureBorderColor,l9_54,vec4(l9_52));
}
#else
{
l9_55=l9_54;
...
#endif
vec3 l9_56=mix(background_color.xyz,foreground_color,vec3(l9_7.x));
vec4 l9_57;
#if (baseTexLayout==2)
{
...
vec4 l9_80=texture(baseTexArrSC,l9_79,0.0);
vec4 l9_81;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
vec4 l9_104=texture(baseTex,l9_103.xy,0.0);
vec4 l9_105;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#endif
float l9_106=l9_57.x*(l9_7.x+background_alpha);
vec4 l9_107=vec4(l9_56.x,l9_56.y,l9_56.z,vec4(0.0).w);
l9_107.w=l9_106;
#if (sc_BlendMode_AlphaTest)
{
if (l9_106<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_106<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_108,vec4(0.0)));
return;
}
vec4 l9_110;
...
{
l9_112=clamp(l9_106*2.0,0.0,1.0);
}
#else
{
float l9_113;
...
{
l9_113=clamp(dot(l9_107.xyz,vec3(l9_106)),0.0,1.0);
}
#else
{
float l9_114;
...
{
l9_115=(1.0-dot(l9_107.xyz,vec3(0.33333001)))*l9_106;
}
#else
{
float l9_116;
...
{
l9_116=(1.0-clamp(dot(l9_107.xyz,vec3(1.0)),0.0,1.0))*l9_106;
}
#else
{
float l9_117;
...
{
l9_117=clamp(dot(l9_107.xyz,vec3(1.0)),0.0,1.0)*l9_106;
}
#else
{
float l9_118;
#if (sc_BlendMode_Add)
{
l9_118=clamp(dot(l9_107.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_119;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_119=clamp(dot(l9_107.xyz,vec3(1.0)),0.0,1.0)*l9_106;
}
#else
{
float l9_120;
...
{
l9_120=dot(l9_107.xyz,vec3(0.33333001))*l9_106;
}
#else
{
float l9_121;
#if (sc_BlendMode_Min)
{
l9_121=1.0-clamp(dot(l9_107.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_122;
#if (sc_BlendMode_Max)
{
l9_122=clamp(dot(l9_107.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_122=1.0;
...
#endif
l9_110=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_107.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_111);
}
#else
{
vec4 l9_123;
...
{
l9_127=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_126,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_127=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_126,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_125=l9_127;
}
#endif
vec3 l9_128=mix(l9_125.xyz,definedBlend(l9_125.xyz,l9_107.xyz).xyz,vec3(l9_106));
vec4 l9_129=vec4(l9_128.x,l9_128.y,l9_128.z,vec4(0.0).w);
l9_129.w=1.0;
l9_124=l9_129;
}
#else
...
#if (sc_Voxelization)
{
l9_130=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_131;
#if (sc_OutputBounds)
{
float l9_132=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_131=vec4(l9_132,1.0-l9_132,1.0,1.0);
}
#else
{
vec4 l9_133;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_133=vec4(mix(vec3(1.0),l9_107.xyz,vec3(l9_106)),l9_106);
}
#else
{
vec4 l9_134;
...
#endif
l9_134=vec4(l9_107.xyz*l9_135,l9_135);
}
#else
{
l9_134=l9_107;
...
vec4 l9_138=sc_OutputMotionVectorIfNeeded(max(l9_136,vec4(0.0)));
