...
//sampler sampler TextureSmpSC 0:21
...
//texture texture2D Texture 0:3:0:21
...
//texture texture2DArray TextureArrSC 0:32:0:21
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Texture 31 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 32 0
//spec_const bool SC_USE_UV_MIN_MAX_Texture 33 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34 0
//spec_const bool SC_USE_UV_TRANSFORM_Texture 35 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36 0
//spec_const bool TextureHasSwappedViews 37 0
//spec_const bool Tweak_N19 38 0
//spec_const bool Tweak_N8 39 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Texture 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Texture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 81 -1
//spec_const int TextureLayout 82 0
...
#define sc_OutputBounds 1
#endif
#ifndef TextureHasSwappedViews
#define TextureHasSwappedViews 0
#elif TextureHasSwappedViews==1
#undef TextureHasSwappedViews
#define TextureHasSwappedViews 1
#endif
#ifndef TextureLayout
#define TextureLayout 0
#endif
#ifndef SC_USE_UV_TRANSFORM_Texture
#define SC_USE_UV_TRANSFORM_Texture 0
#elif SC_USE_UV_TRANSFORM_Texture==1
#undef SC_USE_UV_TRANSFORM_Texture
#define SC_USE_UV_TRANSFORM_Texture 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_Texture
#define SC_SOFTWARE_WRAP_MODE_U_Texture -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_Texture
#define SC_SOFTWARE_WRAP_MODE_V_Texture -1
#endif
#ifndef SC_USE_UV_MIN_MAX_Texture
#define SC_USE_UV_MIN_MAX_Texture 0
#elif SC_USE_UV_MIN_MAX_Texture==1
#undef SC_USE_UV_MIN_MAX_Texture
#define SC_USE_UV_MIN_MAX_Texture 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_Texture
#define SC_USE_CLAMP_TO_BORDER_Texture 0
#elif SC_USE_CLAMP_TO_BORDER_Texture==1
#undef SC_USE_CLAMP_TO_BORDER_Texture
#define SC_USE_CLAMP_TO_BORDER_Texture 1
#endif
#ifndef Tweak_N19
#define Tweak_N19 0
#elif Tweak_N19==1
...
uniform vec2 Port_Import_N041;
uniform vec2 Port_Item0_N049;
uniform vec2 Port_Item1_N049;
uniform vec2 Port_Item2_N049;
uniform vec2 Port_Item3_N049;
uniform vec2 Port_Item4_N049;
uniform vec2 Port_Item5_N049;
uniform vec2 Port_Item6_N049;
uniform vec2 Port_Item7_N049;
uniform float Port_Input1_N039;
uniform mat3 TextureTransform;
uniform vec4 TextureUvMinMax;
uniform vec4 TextureBorderColor;
uniform float Port_Input2_N054;
uniform vec4 Port_Input1_N057;
uniform float Tweak_N29;
uniform float Tweak_N28;
uniform float Tweak_N27;
...
uniform vec4 Port_Input0_N026;
uniform vec4 Port_Color_N002;
...
uniform sampler2DArray TextureArrSC;
...
int TextureGetStereoViewIndex()
{
int l9_0;
#if (TextureHasSwappedViews)
{
...
void Node49_Float_Array_Value(float Index,out vec2 Value,out float SizeOut,vec2 Item0,vec2 Item1,vec2 Item2,vec2 Item3,vec2 Item4,vec2 Item5,vec2 Item6,vec2 Item7,ssGlobals Globals)
{
vec2 Array[8];
Array[0]=Item0;
Array[1]=Item1;
...
void LoopFunction_N53(float Index,float Ratio,inout vec4 Output,ssGlobals Globals)
{
...
vec2 param_1;
float param_2;
Node49_Float_Array_Value(Globals.Loop_Index_ID0,param_1,param_2,Port_Item0_N049,Port_Item1_N049,Port_Item2_N049,Port_Item3_N049,Port_Item4_N049,Port_Item5_N049,Port_Item6_N049,Port_Item7_N049,Globals);
vec2 l9_1=param_1;
vec2 l9_2=l9_0+((Port_Import_N041*vec2(exp2(Tweak_N20)))*l9_1);
float l9_3=Tweak_N20+Port_Input1_N039;
vec4 l9_4;
#if (TextureLayout==2)
{
bool l9_5=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Texture)!=0));
float l9_6=l9_2.x;
sc_SoftwareWrapEarly(l9_6,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x);
float l9_7=l9_6;
float l9_8=l9_2.y;
sc_SoftwareWrapEarly(l9_8,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y);
float l9_9=l9_8;
vec2 l9_10;
float l9_11;
#if (SC_USE_UV_MIN_MAX_Texture)
{
bool l9_12;
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_12=ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x==3;
}
#else
{
l9_12=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0);
}
#endif
float l9_13=l9_7;
float l9_14=1.0;
sc_ClampUV(l9_13,TextureUvMinMax.x,TextureUvMinMax.z,l9_12,l9_14);
float l9_15=l9_13;
float l9_16=l9_14;
bool l9_17;
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_17=ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y==3;
}
#else
{
l9_17=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0);
}
#endif
float l9_18=l9_9;
float l9_19=l9_16;
sc_ClampUV(l9_18,TextureUvMinMax.y,TextureUvMinMax.w,l9_17,l9_19);
l9_11=l9_19;
...
#endif
vec2 l9_20=sc_TransformUV(l9_10,(int(SC_USE_UV_TRANSFORM_Texture)!=0),TextureTransform);
float l9_21=l9_20.x;
float l9_22=l9_11;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x,l9_5,l9_22);
float l9_23=l9_20.y;
float l9_24=l9_22;
sc_SoftwareWrapLate(l9_23,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y,l9_5,l9_24);
float l9_25=l9_24;
vec3 l9_26=sc_SamplingCoordsViewToGlobal(vec2(l9_21,l9_23),TextureLayout,TextureGetStereoViewIndex());
vec4 l9_27=texture(TextureArrSC,l9_26,l9_3);
vec4 l9_28;
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_28=mix(TextureBorderColor,l9_27,vec4(l9_25));
}
#else
{
l9_28=l9_27;
...
#else
{
bool l9_29=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Texture)!=0));
float l9_30=l9_2.x;
sc_SoftwareWrapEarly(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x);
float l9_31=l9_30;
float l9_32=l9_2.y;
sc_SoftwareWrapEarly(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y);
float l9_33=l9_32;
vec2 l9_34;
float l9_35;
#if (SC_USE_UV_MIN_MAX_Texture)
...
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_36=ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x==3;
}
#else
{
l9_36=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0);
}
#endif
float l9_37=l9_31;
float l9_38=1.0;
sc_ClampUV(l9_37,TextureUvMinMax.x,TextureUvMinMax.z,l9_36,l9_38);
float l9_39=l9_37;
float l9_40=l9_38;
bool l9_41;
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_41=ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y==3;
}
#else
{
l9_41=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0);
}
#endif
float l9_42=l9_33;
float l9_43=l9_40;
sc_ClampUV(l9_42,TextureUvMinMax.y,TextureUvMinMax.w,l9_41,l9_43);
l9_35=l9_43;
...
#endif
vec2 l9_44=sc_TransformUV(l9_34,(int(SC_USE_UV_TRANSFORM_Texture)!=0),TextureTransform);
float l9_45=l9_44.x;
float l9_46=l9_35;
sc_SoftwareWrapLate(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x,l9_29,l9_46);
float l9_47=l9_44.y;
float l9_48=l9_46;
sc_SoftwareWrapLate(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y,l9_29,l9_48);
float l9_49=l9_48;
vec3 l9_50=sc_SamplingCoordsViewToGlobal(vec2(l9_45,l9_47),TextureLayout,TextureGetStereoViewIndex());
vec4 l9_51=texture(Texture,l9_50.xy,l9_3);
vec4 l9_52;
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_52=mix(TextureBorderColor,l9_51,vec4(l9_49));
}
#else
{
l9_52=l9_51;
...
void Node53_Loop_8x(vec4 Input,out vec4 Output,ssGlobals Globals)
{
Output=vec4(0.0);
Globals.Loop_Count_ID0=8.0;
LoopFunction_N53(0.0,0.0,Output,Globals);
LoopFunction_N53(1.0,0.142857,Output,Globals);
LoopFunction_N53(2.0,0.285714,Output,Globals);
LoopFunction_N53(3.0,0.42857099,Output,Globals);
LoopFunction_N53(4.0,0.57142901,Output,Globals);
LoopFunction_N53(5.0,0.71428603,Output,Globals);
LoopFunction_N53(6.0,0.85714298,Output,Globals);
LoopFunction_N53(7.0,1.0,Output,Globals);
Output/=vec4(8.0);
}
void Node59_Blend(vec4 Base,vec4 Color,out vec4 Output,ssGlobals Globals)
{
vec3 l9_0=(Base.xyz*2.0)*Color.xyz;
vec3 l9_1=vec3(1.0)-(((vec3(1.0)-Base.xyz)*2.0)*(vec3(1.0)-Color.xyz));
float l9_2;
if (Base.x<0.5)
{
l9_2=l9_0.x;
...
vec3 l9_5=vec3(l9_2,l9_3,l9_4);
Output=vec4(l9_5.x,l9_5.y,l9_5.z,Output.w);
vec3 l9_6=mix(Base.xyz,Output.xyz,vec3(Color.w));
Output=vec4(l9_6.x,l9_6.y,l9_6.z,Output.w);
Output.w=Base.w;
}
void Node60_If_else(float Bool1,vec4 Value1,vec4 Default,out vec4 Result,ssGlobals Globals)
{
#if (Tweak_N19)
{
vec2 l9_0=Globals.gScreenCoord;
...
#if (TextureLayout==2)
{
bool l9_2=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Texture)!=0));
float l9_3=l9_0.x;
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x);
float l9_4=l9_3;
float l9_5=l9_0.y;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y);
float l9_6=l9_5;
vec2 l9_7;
float l9_8;
#if (SC_USE_UV_MIN_MAX_Texture)
...
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_9=ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x==3;
}
#else
{
l9_9=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0);
}
#endif
float l9_10=l9_4;
float l9_11=1.0;
sc_ClampUV(l9_10,TextureUvMinMax.x,TextureUvMinMax.z,l9_9,l9_11);
float l9_12=l9_10;
float l9_13=l9_11;
bool l9_14;
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_14=ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y==3;
}
#else
{
l9_14=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0);
}
#endif
float l9_15=l9_6;
float l9_16=l9_13;
sc_ClampUV(l9_15,TextureUvMinMax.y,TextureUvMinMax.w,l9_14,l9_16);
l9_8=l9_16;
...
#endif
vec2 l9_17=sc_TransformUV(l9_7,(int(SC_USE_UV_TRANSFORM_Texture)!=0),TextureTransform);
float l9_18=l9_17.x;
float l9_19=l9_8;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x,l9_2,l9_19);
float l9_20=l9_17.y;
float l9_21=l9_19;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y,l9_2,l9_21);
float l9_22=l9_21;
vec3 l9_23=sc_SamplingCoordsViewToGlobal(vec2(l9_18,l9_20),TextureLayout,TextureGetStereoViewIndex());
vec4 l9_24=texture(TextureArrSC,l9_23,0.0);
vec4 l9_25;
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_25=mix(TextureBorderColor,l9_24,vec4(l9_22));
}
#else
{
l9_25=l9_24;
...
#else
{
bool l9_26=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Texture)!=0));
float l9_27=l9_0.x;
sc_SoftwareWrapEarly(l9_27,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x);
float l9_28=l9_27;
float l9_29=l9_0.y;
sc_SoftwareWrapEarly(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y);
float l9_30=l9_29;
vec2 l9_31;
float l9_32;
#if (SC_USE_UV_MIN_MAX_Texture)
...
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_33=ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x==3;
}
#else
{
l9_33=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0);
}
#endif
float l9_34=l9_28;
float l9_35=1.0;
sc_ClampUV(l9_34,TextureUvMinMax.x,TextureUvMinMax.z,l9_33,l9_35);
float l9_36=l9_34;
float l9_37=l9_35;
bool l9_38;
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_38=ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y==3;
}
#else
{
l9_38=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0);
}
#endif
float l9_39=l9_30;
float l9_40=l9_37;
sc_ClampUV(l9_39,TextureUvMinMax.y,TextureUvMinMax.w,l9_38,l9_40);
l9_32=l9_40;
...
#endif
vec2 l9_41=sc_TransformUV(l9_31,(int(SC_USE_UV_TRANSFORM_Texture)!=0),TextureTransform);
float l9_42=l9_41.x;
float l9_43=l9_32;
sc_SoftwareWrapLate(l9_42,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x,l9_26,l9_43);
float l9_44=l9_41.y;
float l9_45=l9_43;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y,l9_26,l9_45);
float l9_46=l9_45;
vec3 l9_47=sc_SamplingCoordsViewToGlobal(vec2(l9_42,l9_44),TextureLayout,TextureGetStereoViewIndex());
vec4 l9_48=texture(Texture,l9_47.xy,0.0);
vec4 l9_49;
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_49=mix(TextureBorderColor,l9_48,vec4(l9_46));
}
#else
{
l9_49=l9_48;
...
#endif
float l9_50=Tweak_N20+Port_Input1_N039;
vec4 l9_51;
#if (TextureLayout==2)
{
bool l9_52=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Texture)!=0));
float l9_53=l9_0.x;
sc_SoftwareWrapEarly(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x);
float l9_54=l9_53;
float l9_55=l9_0.y;
sc_SoftwareWrapEarly(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y);
float l9_56=l9_55;
vec2 l9_57;
float l9_58;
#if (SC_USE_UV_MIN_MAX_Texture)
...
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_59=ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x==3;
}
#else
{
l9_59=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0);
}
#endif
float l9_60=l9_54;
float l9_61=1.0;
sc_ClampUV(l9_60,TextureUvMinMax.x,TextureUvMinMax.z,l9_59,l9_61);
float l9_62=l9_60;
float l9_63=l9_61;
bool l9_64;
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_64=ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y==3;
}
#else
{
l9_64=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0);
}
#endif
float l9_65=l9_56;
float l9_66=l9_63;
sc_ClampUV(l9_65,TextureUvMinMax.y,TextureUvMinMax.w,l9_64,l9_66);
l9_58=l9_66;
...
#endif
vec2 l9_67=sc_TransformUV(l9_57,(int(SC_USE_UV_TRANSFORM_Texture)!=0),TextureTransform);
float l9_68=l9_67.x;
float l9_69=l9_58;
sc_SoftwareWrapLate(l9_68,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x,l9_52,l9_69);
float l9_70=l9_67.y;
float l9_71=l9_69;
sc_SoftwareWrapLate(l9_70,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y,l9_52,l9_71);
float l9_72=l9_71;
vec3 l9_73=sc_SamplingCoordsViewToGlobal(vec2(l9_68,l9_70),TextureLayout,TextureGetStereoViewIndex());
vec4 l9_74=texture(TextureArrSC,l9_73,l9_50);
vec4 l9_75;
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_75=mix(TextureBorderColor,l9_74,vec4(l9_72));
}
#else
{
l9_75=l9_74;
...
#else
{
bool l9_76=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Texture)!=0));
float l9_77=l9_0.x;
sc_SoftwareWrapEarly(l9_77,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x);
float l9_78=l9_77;
float l9_79=l9_0.y;
sc_SoftwareWrapEarly(l9_79,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y);
float l9_80=l9_79;
vec2 l9_81;
float l9_82;
#if (SC_USE_UV_MIN_MAX_Texture)
...
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_83=ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x==3;
}
#else
{
l9_83=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0);
}
#endif
float l9_84=l9_78;
float l9_85=1.0;
sc_ClampUV(l9_84,TextureUvMinMax.x,TextureUvMinMax.z,l9_83,l9_85);
float l9_86=l9_84;
float l9_87=l9_85;
bool l9_88;
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_88=ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y==3;
}
#else
{
l9_88=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0);
}
#endif
float l9_89=l9_80;
float l9_90=l9_87;
sc_ClampUV(l9_89,TextureUvMinMax.y,TextureUvMinMax.w,l9_88,l9_90);
l9_82=l9_90;
...
#endif
vec2 l9_91=sc_TransformUV(l9_81,(int(SC_USE_UV_TRANSFORM_Texture)!=0),TextureTransform);
float l9_92=l9_91.x;
float l9_93=l9_82;
sc_SoftwareWrapLate(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x,l9_76,l9_93);
float l9_94=l9_91.y;
float l9_95=l9_93;
sc_SoftwareWrapLate(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y,l9_76,l9_95);
float l9_96=l9_95;
vec3 l9_97=sc_SamplingCoordsViewToGlobal(vec2(l9_92,l9_94),TextureLayout,TextureGetStereoViewIndex());
vec4 l9_98=texture(Texture,l9_97.xy,l9_50);
vec4 l9_99;
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_99=mix(TextureBorderColor,l9_98,vec4(l9_96));
}
#else
{
l9_99=l9_98;
...
#endif
vec4 param_1;
Node53_Loop_8x(vec4(0.0),param_1,Globals);
vec4 param_5;
Node59_Blend((l9_1-mix(l9_51,param_1,vec4(Port_Input2_N054)))+Port_Input1_N057,l9_1,param_5,Globals);
Value1=param_5;
Result=Value1;
}
#else
{
vec2 l9_100=Globals.gScreenCoord;
vec4 l9_101;
#if (TextureLayout==2)
{
bool l9_102=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Texture)!=0));
float l9_103=l9_100.x;
sc_SoftwareWrapEarly(l9_103,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x);
float l9_104=l9_103;
float l9_105=l9_100.y;
sc_SoftwareWrapEarly(l9_105,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y);
float l9_106=l9_105;
vec2 l9_107;
float l9_108;
#if (SC_USE_UV_MIN_MAX_Texture)
...
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_109=ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x==3;
}
#else
{
l9_109=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0);
}
#endif
float l9_110=l9_104;
float l9_111=1.0;
sc_ClampUV(l9_110,TextureUvMinMax.x,TextureUvMinMax.z,l9_109,l9_111);
float l9_112=l9_110;
float l9_113=l9_111;
bool l9_114;
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_114=ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y==3;
}
#else
{
l9_114=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0);
}
#endif
float l9_115=l9_106;
float l9_116=l9_113;
sc_ClampUV(l9_115,TextureUvMinMax.y,TextureUvMinMax.w,l9_114,l9_116);
l9_108=l9_116;
...
#endif
vec2 l9_117=sc_TransformUV(l9_107,(int(SC_USE_UV_TRANSFORM_Texture)!=0),TextureTransform);
float l9_118=l9_117.x;
float l9_119=l9_108;
sc_SoftwareWrapLate(l9_118,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x,l9_102,l9_119);
float l9_120=l9_117.y;
float l9_121=l9_119;
sc_SoftwareWrapLate(l9_120,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y,l9_102,l9_121);
float l9_122=l9_121;
vec3 l9_123=sc_SamplingCoordsViewToGlobal(vec2(l9_118,l9_120),TextureLayout,TextureGetStereoViewIndex());
vec4 l9_124=texture(TextureArrSC,l9_123,0.0);
vec4 l9_125;
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_125=mix(TextureBorderColor,l9_124,vec4(l9_122));
}
#else
{
l9_125=l9_124;
...
#else
{
bool l9_126=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Texture)!=0));
float l9_127=l9_100.x;
sc_SoftwareWrapEarly(l9_127,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x);
float l9_128=l9_127;
float l9_129=l9_100.y;
sc_SoftwareWrapEarly(l9_129,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y);
float l9_130=l9_129;
vec2 l9_131;
float l9_132;
#if (SC_USE_UV_MIN_MAX_Texture)
...
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_133=ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x==3;
}
#else
{
l9_133=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0);
}
#endif
float l9_134=l9_128;
float l9_135=1.0;
sc_ClampUV(l9_134,TextureUvMinMax.x,TextureUvMinMax.z,l9_133,l9_135);
float l9_136=l9_134;
float l9_137=l9_135;
bool l9_138;
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_138=ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y==3;
}
#else
{
l9_138=(int(SC_USE_CLAMP_TO_BORDER_Texture)!=0);
}
#endif
float l9_139=l9_130;
float l9_140=l9_137;
sc_ClampUV(l9_139,TextureUvMinMax.y,TextureUvMinMax.w,l9_138,l9_140);
l9_132=l9_140;
...
#endif
vec2 l9_141=sc_TransformUV(l9_131,(int(SC_USE_UV_TRANSFORM_Texture)!=0),TextureTransform);
float l9_142=l9_141.x;
float l9_143=l9_132;
sc_SoftwareWrapLate(l9_142,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).x,l9_126,l9_143);
float l9_144=l9_141.y;
float l9_145=l9_143;
sc_SoftwareWrapLate(l9_144,ivec2(SC_SOFTWARE_WRAP_MODE_U_Texture,SC_SOFTWARE_WRAP_MODE_V_Texture).y,l9_126,l9_145);
float l9_146=l9_145;
vec3 l9_147=sc_SamplingCoordsViewToGlobal(vec2(l9_142,l9_144),TextureLayout,TextureGetStereoViewIndex());
vec4 l9_148=texture(Texture,l9_147.xy,0.0);
vec4 l9_149;
#if (SC_USE_CLAMP_TO_BORDER_Texture)
{
l9_149=mix(TextureBorderColor,l9_148,vec4(l9_146));
}
#else
{
l9_149=l9_148;
...
vec3 ssRGB_to_HSV(vec3 RGB)
{
RGB=clamp(RGB,vec3(0.0),vec3(1.0));
float l9_0=RGB.x;
float l9_1=RGB.y;
float l9_2=RGB.z;
float l9_3=max(max(l9_0,l9_1),l9_2);
vec3 l9_4=vec3(0.0);
l9_4.z=l9_3;
float l9_5=RGB.x;
float l9_6=RGB.y;
float l9_7=RGB.z;
float l9_8=l9_3-min(min(l9_5,l9_6),l9_7);
vec3 l9_9=vec3(0.0,0.33333334,0.66666669)+(((RGB.yzx-RGB.zxy)*0.16666667)/vec3(l9_8));
vec2 l9_10;
if (l9_8==0.0)
{
l9_10=vec2(0.0);
...
l9_10=vec2(l9_11,l9_8/l9_3);
}
return vec3(l9_10.x,l9_10.y,l9_4.z);
}
...
ssGlobals l9_4=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_1,0.0,0.0,0.0);
vec4 l9_5;
#if (Tweak_N8)
{
vec4 l9_6;
Node60_If_else(0.0,vec4(0.0),vec4(0.0),l9_6,l9_4);
vec4 l9_7=vec4(ssRGB_to_HSV(l9_6.xyz),l9_6.w)+vec4((((clamp(Tweak_N29,-180.0,180.0)-Port_RangeMinA_N001)/((Port_RangeMaxA_N001-Port_RangeMinA_N001)+1e-06))*(Port_RangeMaxB_N001-Port_RangeMinB_N001))+Port_RangeMinB_N001,clamp(Tweak_N28,-100.0,100.0)*Port_Input1_N006,clamp(Tweak_N27,-100.0,100.0)*Port_Input1_N007,0.0);
vec4 l9_8=mix(Port_Input0_N026,vec4(ssHSV_to_RGB(l9_7.xyz),l9_7.w)*vec4(clamp(Tweak_N21,0.0,5.0)),vec4(clamp(Tweak_N15,0.0,2.0)));
vec3 l9_9=l9_8.xyz;
vec3 l9_10=mix(l9_9,(vec3(1.0)-abs((vec3(1.0)-l9_9)-Port_Color_N002.xyz)).xyz,vec3(Port_Color_N002.w));
...
{
vec4 l9_12;
Node60_If_else(0.0,vec4(0.0),vec4(0.0),l9_12,l9_4);
vec4 l9_13=vec4(ssRGB_to_HSV(l9_12.xyz),l9_12.w)+vec4((((clamp(Tweak_N29,-180.0,180.0)-Port_RangeMinA_N001)/((Port_RangeMaxA_N001-Port_RangeMinA_N001)+1e-06))*(Port_RangeMaxB_N001-Port_RangeMinB_N001))+Port_RangeMinB_N001,clamp(Tweak_N28,-100.0,100.0)*Port_Input1_N006,clamp(Tweak_N27,-100.0,100.0)*Port_Input1_N007,0.0);
l9_5=mix(Port_Input0_N026,vec4(ssHSV_to_RGB(l9_13.xyz),l9_13.w)*vec4(clamp(Tweak_N21,0.0,5.0)),vec4(clamp(Tweak_N15,0.0,2.0)));
}
#endif
...
{
l9_18=clamp(l9_5.w*2.0,0.0,1.0);
}
#else
{
float l9_19;
...
{
l9_19=clamp(dot(l9_5.xyz,vec3(l9_5.w)),0.0,1.0);
}
#else
{
float l9_20;
...
{
l9_21=(1.0-dot(l9_5.xyz,vec3(0.33333001)))*l9_5.w;
}
#else
{
float l9_22;
...
{
l9_22=(1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0))*l9_5.w;
}
#else
{
float l9_23;
...
{
l9_23=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_5.w;
}
#else
{
float l9_24;
#if (sc_BlendMode_Add)
{
l9_24=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_25;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_25=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_5.w;
}
#else
{
float l9_26;
...
{
l9_26=dot(l9_5.xyz,vec3(0.33333001))*l9_5.w;
}
#else
{
float l9_27;
#if (sc_BlendMode_Min)
{
l9_27=1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_28;
#if (sc_BlendMode_Max)
{
l9_28=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_28=1.0;
...
#endif
l9_16=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_5.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_17);
}
#else
{
vec4 l9_29;
...
{
l9_33=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_32,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_33=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_32,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_31=l9_33;
}
#endif
vec3 l9_34=mix(l9_31.xyz,definedBlend(l9_31.xyz,l9_5.xyz).xyz,vec3(l9_5.w));
...
#if (sc_Voxelization)
{
l9_36=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_37;
#if (sc_OutputBounds)
{
float l9_38=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_37=vec4(l9_38,1.0-l9_38,1.0,1.0);
}
#else
{
vec4 l9_39;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_39=vec4(mix(vec3(1.0),l9_5.xyz,vec3(l9_5.w)),l9_5.w);
}
#else
{
vec4 l9_40;
...
#endif
l9_40=vec4(l9_5.xyz*l9_41,l9_41);
}
#else
{
l9_40=l9_5;
...
vec4 l9_44=sc_OutputMotionVectorIfNeeded(max(l9_42,vec4(0.0)));
