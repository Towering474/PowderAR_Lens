...
//sampler sampler opacityMapSmpSC 0:22
...
//texture texture2D opacityMap 0:4:0:22
...
//texture texture2DArray opacityMapArrSC 0:33:0:22
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityMap 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityMap 79 -1
//spec_const int intensityTextureLayout 80 0
//spec_const int opacityMapLayout 81 0
...
#define sc_OutputBounds 1
#endif
#ifndef opacityMapHasSwappedViews
#define opacityMapHasSwappedViews 0
#elif opacityMapHasSwappedViews==1
#undef opacityMapHasSwappedViews
#define opacityMapHasSwappedViews 1
#endif
#ifndef sc_DepthOnly
...
#endif
#ifndef opacityMapLayout
#define opacityMapLayout 0
#endif
#ifndef SC_USE_UV_TRANSFORM_opacityMap
#define SC_USE_UV_TRANSFORM_opacityMap 0
#elif SC_USE_UV_TRANSFORM_opacityMap==1
#undef SC_USE_UV_TRANSFORM_opacityMap
#define SC_USE_UV_TRANSFORM_opacityMap 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_opacityMap
#define SC_SOFTWARE_WRAP_MODE_U_opacityMap -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_opacityMap
#define SC_SOFTWARE_WRAP_MODE_V_opacityMap -1
#endif
#ifndef SC_USE_UV_MIN_MAX_opacityMap
#define SC_USE_UV_MIN_MAX_opacityMap 0
#elif SC_USE_UV_MIN_MAX_opacityMap==1
#undef SC_USE_UV_MIN_MAX_opacityMap
#define SC_USE_UV_MIN_MAX_opacityMap 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_opacityMap
#define SC_USE_CLAMP_TO_BORDER_opacityMap 0
#elif SC_USE_CLAMP_TO_BORDER_opacityMap==1
#undef SC_USE_CLAMP_TO_BORDER_opacityMap
#define SC_USE_CLAMP_TO_BORDER_opacityMap 1
#endif
layout(binding=1,std430) readonly buffer sc_RayTracingCasterVertexBuffer
{
float sc_RayTracingCasterVertices[1];
...
uniform float value;
uniform float Port_Value_N040;
uniform float Port_Value_N043;
uniform float Port_Input0_N047;
uniform float Port_Input0_N050;
uniform float Port_Value4_N211;
uniform float Port_RangeMinA_N061;
uniform float Port_RangeMaxA_N061;
uniform float Port_RangeMaxB_N061;
uniform float Port_RangeMinB_N061;
uniform vec2 Port_Import_N062;
uniform vec2 Port_Center_N063;
uniform vec2 Port_Value_N017;
uniform float Port_Value1_N024;
uniform float Port_Default_N024;
uniform vec2 Port_Center_N022;
uniform vec2 Port_Value_N019;
...
uniform vec4 opacityMapSize;
uniform float borderScale;
uniform int PreviewEnabled;
uniform int PreviewNodeID;
uniform vec4 sc_Time;
uniform vec4 Port_Default_N038;
uniform float Port_Import_N032;
uniform float Port_Import_N035;
uniform float Port_Import_N033;
uniform float Port_Import_N036;
uniform mat3 opacityMapTransform;
uniform vec4 opacityMapUvMinMax;
uniform vec4 opacityMapBorderColor;
uniform usampler2D sc_RayTracingHitCasterIdAndBarycentric;
uniform sampler2D sc_RayTracingRayDirection;
uniform sampler2D opacityMap;
uniform sampler2DArray opacityMapArrSC;
...
void Node1_If_else(float Bool1,float Value1,float Default,out float Result,ssGlobals Globals)
{
Bool1=float(isVertical);
if ((Bool1*1.0)!=0.0)
{
Value1=Globals.Surface_UVCoord0.y;
Result=Value1;
}
else
{
Default=Globals.Surface_UVCoord0.x;
Result=Default;
}
}
int sc_GetStereoViewIndex()
...
int opacityMapGetStereoViewIndex()
{
int l9_0;
#if (opacityMapHasSwappedViews)
{
...
void sc_ClampUV(inout float value_1,float minValue,float maxValue,bool useClampToBorder,inout float clampToBorderFactor)
{
float l9_0=clamp(value_1,minValue,maxValue);
float l9_1=step(abs(value_1-l9_0),9.9999997e-06);
...
float packValue(inout int value_1)
{
...
ssGlobals l9_4=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_2);
float l9_5=floor(float(paletteType));
vec4 l9_6;
if (l9_5==0.0)
{
float l9_7;
Node1_If_else(0.0,0.0,0.0,l9_7,l9_4);
float l9_8=l9_7;
float l9_9=(Port_Value_N040+0.001)-0.001;
float l9_10=(Port_Value_N043+0.001)-0.001;
float l9_11=mix(Port_Input0_N047,(l9_9/l9_10)*(1.0-l9_8),float(l9_8>((l9_9-l9_10)/l9_9)))*clamp(brightness,0.0,1.0);
float l9_12=l9_10/l9_9;
float l9_13=mix(Port_Input0_N050,l9_8/l9_12,float(l9_8<l9_12))*clamp(saturation,0.0,1.0);
vec4 l9_14=vec4(l9_8,l9_11,l9_13,Port_Value4_N211);
float l9_15=3.0*fract(l9_8+0.16666667);
float l9_16=2.0*fract(l9_15);
vec2 l9_17=l9_14.zz-((vec2(1.0,l9_16)-vec2(max(0.0,l9_16-1.0)))*(l9_13*clamp(l9_11,0.0,1.0)));
vec3 l9_18=vec3(l9_14.z,l9_17.x,l9_17.y);
vec3 l9_19;
if (l9_15>=1.0)
{
l9_19=l9_18.zxy;
...
l9_6=vec4(l9_20,Port_Value4_N211);
}
else
{
vec4 l9_21;
if (l9_5==1.0)
{
vec2 l9_22=l9_2-vec2(Port_RangeMinA_N061);
float l9_23;
if ((float(isVertical)*1.0)!=0.0)
{
l9_23=Port_Value1_N024;
}
else
{
l9_23=Port_Default_N024;
}
float l9_24=radians(l9_23);
float l9_25=sin(l9_24);
float l9_26=cos(l9_24);
vec2 l9_27=((Port_Value_N017+vec2(0.001))-vec2(0.001))-Port_Center_N022;
vec2 l9_28=vec2(l9_26,l9_25);
vec2 l9_29=vec2(-l9_25,l9_26);
vec2 l9_30=vec2(dot(l9_28,l9_27),dot(l9_29,l9_27))+Port_Center_N022;
vec2 l9_31=((Port_Value_N019+vec2(0.001))-vec2(0.001))-Port_Center_N023;
vec2 l9_32=(vec2(dot(l9_28,l9_31),dot(l9_29,l9_31))+Port_Center_N023)-l9_30;
l9_21=mix(colorEnd,colorStart,vec4(smoothstep(Port_Input0_N072,Port_Input1_N072,clamp((dot(((((((l9_22/vec2((Port_RangeMaxA_N061-Port_RangeMinA_N061)+1e-06))*(Port_RangeMaxB_N061-Port_RangeMinB_N061))+vec2(Port_RangeMinB_N061))-Port_Center_N063)*Port_Import_N062)+Port_Center_N063)-l9_30,l9_32)/dot(l9_32,l9_32))+0.001,Port_Input1_N071+0.001,Port_Input2_N071+0.001)-0.001)));
}
else
{
vec4 l9_33;
...
{
float l9_34;
Node1_If_else(0.0,0.0,0.0,l9_34,l9_4);
l9_33=mix(colorStart,colorEnd,vec4(step(value,l9_34)));
}
else
{
l9_33=Port_Default_N038;
}
l9_21=l9_33;
}
l9_6=l9_21;
}
vec2 l9_35=vec2(length(sc_ModelMatrix[0].xyz),length(sc_ModelMatrix[1].xyz));
bool l9_36=(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].w+0.00050000002)>0.0;
bool l9_37;
if (l9_36)
{
l9_37=(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].w-0.00050000002)<0.0;
}
else
{
l9_37=l9_36;
...
if (!l9_37)
{
l9_38=l9_35*(abs(vec2(0.0,sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][1].y)).y/0.1);
}
else
{
l9_38=l9_35;
}
float l9_39=min(min(clamp(borderScale,0.0,1.0),l9_38.x/2.0),l9_38.y/2.0);
float l9_40=(opacityMapSize.x/opacityMapSize.y)*l9_39;
float l9_41=((Port_Import_N032*l9_40)*2.0)/l9_38.x;
float l9_42=1.0-(((Port_Import_N035*l9_40)*2.0)/l9_38.x);
float l9_43=((Port_Import_N036*l9_39)*2.0)/l9_38.y;
float l9_44=1.0-(((Port_Import_N033*l9_39)*2.0)/l9_38.y);
float l9_45=1.0-Port_Import_N035;
float l9_46=1.0-Port_Import_N033;
float l9_47;
if (l9_2.x<l9_41)
{
l9_47=0.0+(((l9_2.x-0.0)*(Port_Import_N032-0.0))/((l9_41-0.0)+1e-06));
}
else
{
l9_47=(l9_2.x<l9_42) ? (Port_Import_N032+(((l9_2.x-l9_41)*(l9_45-Port_Import_N032))/((l9_42-l9_41)+1e-06))) : (l9_45+(((l9_2.x-l9_42)*(1.0-l9_45))/((1.0-l9_42)+1e-06)));
}
float l9_48;
if (l9_2.y<l9_43)
{
l9_48=0.0+(((l9_2.y-0.0)*(Port_Import_N036-0.0))/((l9_43-0.0)+1e-06));
}
else
{
l9_48=(l9_2.y<l9_44) ? (Port_Import_N036+(((l9_2.y-l9_43)*(l9_46-Port_Import_N036))/((l9_44-l9_43)+1e-06))) : (l9_46+(((l9_2.y-l9_44)*(1.0-l9_46))/((1.0-l9_44)+1e-06)));
}
vec4 l9_49;
#if (opacityMapLayout==2)
{
bool l9_50=(int(SC_USE_CLAMP_TO_BORDER_opacityMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityMap)!=0));
float l9_51=l9_47;
sc_SoftwareWrapEarly(l9_51,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityMap,SC_SOFTWARE_WRAP_MODE_V_opacityMap).x);
float l9_52=l9_51;
float l9_53=l9_48;
sc_SoftwareWrapEarly(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityMap,SC_SOFTWARE_WRAP_MODE_V_opacityMap).y);
float l9_54=l9_53;
vec2 l9_55;
float l9_56;
#if (SC_USE_UV_MIN_MAX_opacityMap)
{
bool l9_57;
#if (SC_USE_CLAMP_TO_BORDER_opacityMap)
{
l9_57=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityMap,SC_SOFTWARE_WRAP_MODE_V_opacityMap).x==3;
}
#else
{
l9_57=(int(SC_USE_CLAMP_TO_BORDER_opacityMap)!=0);
}
#endif
float l9_58=l9_52;
float l9_59=1.0;
sc_ClampUV(l9_58,opacityMapUvMinMax.x,opacityMapUvMinMax.z,l9_57,l9_59);
float l9_60=l9_58;
float l9_61=l9_59;
bool l9_62;
#if (SC_USE_CLAMP_TO_BORDER_opacityMap)
{
l9_62=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityMap,SC_SOFTWARE_WRAP_MODE_V_opacityMap).y==3;
}
#else
{
l9_62=(int(SC_USE_CLAMP_TO_BORDER_opacityMap)!=0);
}
#endif
float l9_63=l9_54;
float l9_64=l9_61;
sc_ClampUV(l9_63,opacityMapUvMinMax.y,opacityMapUvMinMax.w,l9_62,l9_64);
l9_56=l9_64;
l9_55=vec2(l9_60,l9_63);
}
#else
...
#endif
vec2 l9_65=sc_TransformUV(l9_55,(int(SC_USE_UV_TRANSFORM_opacityMap)!=0),opacityMapTransform);
float l9_66=l9_65.x;
float l9_67=l9_56;
sc_SoftwareWrapLate(l9_66,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityMap,SC_SOFTWARE_WRAP_MODE_V_opacityMap).x,l9_50,l9_67);
float l9_68=l9_65.y;
float l9_69=l9_67;
sc_SoftwareWrapLate(l9_68,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityMap,SC_SOFTWARE_WRAP_MODE_V_opacityMap).y,l9_50,l9_69);
float l9_70=l9_69;
vec3 l9_71=sc_SamplingCoordsViewToGlobal(vec2(l9_66,l9_68),opacityMapLayout,opacityMapGetStereoViewIndex());
vec4 l9_72=texture(opacityMapArrSC,l9_71,0.0);
vec4 l9_73;
#if (SC_USE_CLAMP_TO_BORDER_opacityMap)
{
l9_73=mix(opacityMapBorderColor,l9_72,vec4(l9_70));
}
#else
{
l9_73=l9_72;
...
#else
{
bool l9_74=(int(SC_USE_CLAMP_TO_BORDER_opacityMap)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityMap)!=0));
float l9_75=l9_47;
sc_SoftwareWrapEarly(l9_75,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityMap,SC_SOFTWARE_WRAP_MODE_V_opacityMap).x);
float l9_76=l9_75;
float l9_77=l9_48;
sc_SoftwareWrapEarly(l9_77,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityMap,SC_SOFTWARE_WRAP_MODE_V_opacityMap).y);
float l9_78=l9_77;
vec2 l9_79;
float l9_80;
#if (SC_USE_UV_MIN_MAX_opacityMap)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityMap)
{
l9_81=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityMap,SC_SOFTWARE_WRAP_MODE_V_opacityMap).x==3;
}
#else
{
l9_81=(int(SC_USE_CLAMP_TO_BORDER_opacityMap)!=0);
}
#endif
float l9_82=l9_76;
float l9_83=1.0;
sc_ClampUV(l9_82,opacityMapUvMinMax.x,opacityMapUvMinMax.z,l9_81,l9_83);
float l9_84=l9_82;
float l9_85=l9_83;
bool l9_86;
#if (SC_USE_CLAMP_TO_BORDER_opacityMap)
{
l9_86=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityMap,SC_SOFTWARE_WRAP_MODE_V_opacityMap).y==3;
}
#else
{
l9_86=(int(SC_USE_CLAMP_TO_BORDER_opacityMap)!=0);
}
#endif
float l9_87=l9_78;
float l9_88=l9_85;
sc_ClampUV(l9_87,opacityMapUvMinMax.y,opacityMapUvMinMax.w,l9_86,l9_88);
l9_80=l9_88;
l9_79=vec2(l9_84,l9_87);
}
#else
...
#endif
vec2 l9_89=sc_TransformUV(l9_79,(int(SC_USE_UV_TRANSFORM_opacityMap)!=0),opacityMapTransform);
float l9_90=l9_89.x;
float l9_91=l9_80;
sc_SoftwareWrapLate(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityMap,SC_SOFTWARE_WRAP_MODE_V_opacityMap).x,l9_74,l9_91);
float l9_92=l9_89.y;
float l9_93=l9_91;
sc_SoftwareWrapLate(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityMap,SC_SOFTWARE_WRAP_MODE_V_opacityMap).y,l9_74,l9_93);
float l9_94=l9_93;
vec3 l9_95=sc_SamplingCoordsViewToGlobal(vec2(l9_90,l9_92),opacityMapLayout,opacityMapGetStereoViewIndex());
vec4 l9_96=texture(opacityMap,l9_95.xy,0.0);
vec4 l9_97;
#if (SC_USE_CLAMP_TO_BORDER_opacityMap)
{
l9_97=mix(opacityMapBorderColor,l9_96,vec4(l9_94));
}
#else
{
l9_97=l9_96;
...
#endif
float l9_98=l9_49.w*l9_6.w;
vec4 l9_99=vec4(l9_6.xyz,l9_98);
bool l9_100=PreviewEnabled==1;
bool l9_101;
if (l9_100)
{
l9_101=!l9_0;
...
#endif
sc_writeFragData0(max(l9_105,vec4(0.0)));
return;
}
vec4 l9_107;
...
{
l9_109=clamp(l9_98*2.0,0.0,1.0);
}
#else
{
float l9_110;
...
{
l9_110=clamp(dot(l9_99.xyz,vec3(l9_98)),0.0,1.0);
}
#else
{
float l9_111;
...
{
l9_112=(1.0-dot(l9_99.xyz,vec3(0.33333001)))*l9_98;
}
#else
{
float l9_113;
...
{
l9_113=(1.0-clamp(dot(l9_99.xyz,vec3(1.0)),0.0,1.0))*l9_98;
}
#else
{
float l9_114;
...
{
l9_114=clamp(dot(l9_99.xyz,vec3(1.0)),0.0,1.0)*l9_98;
}
#else
{
float l9_115;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_116=clamp(dot(l9_99.xyz,vec3(1.0)),0.0,1.0)*l9_98;
}
#else
{
float l9_117;
...
{
l9_117=dot(l9_99.xyz,vec3(0.33333001))*l9_98;
}
#else
{
float l9_118;
#if (sc_BlendMode_Min)
{
l9_118=1.0-clamp(dot(l9_99.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_119;
#if (sc_BlendMode_Max)
{
l9_119=clamp(dot(l9_99.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_119=1.0;
...
#endif
l9_107=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_99.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_108);
}
#else
{
vec4 l9_120;
...
#endif
vec3 l9_125=mix(l9_122.xyz,definedBlend(l9_122.xyz,l9_99.xyz).xyz,vec3(l9_98));
...
#if (sc_Voxelization)
{
l9_127=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_128;
#if (sc_OutputBounds)
{
float l9_129=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_128=vec4(l9_129,1.0-l9_129,1.0,1.0);
}
#else
{
vec4 l9_130;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_130=vec4(mix(vec3(1.0),l9_99.xyz,vec3(l9_98)),l9_98);
}
#else
{
vec4 l9_131;
...
#endif
l9_131=vec4(l9_99.xyz*l9_132,l9_132);
}
#else
{
l9_131=l9_99;
...
vec4 l9_135=sc_OutputMotionVectorIfNeeded(max(l9_133,vec4(0.0)));
vec4 l9_136=clamp(l9_135,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_137=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_137-0.0039215689)),min(1.0,l9_137+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_138=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_138).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_139=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_138).xy);
float l9_140=packValue(l9_139);
int l9_147=int(l9_136.w*255.0);
float l9_148=packValue(l9_147);
sc_writeFragData0(vec4(packValue(l9_139),packValue(l9_139),packValue(l9_139),packValue(l9_139)));
}
#endif
}
#else
...
if (l9_156==0)
{
l9_159=texture(sc_OITAlpha0,l9_151);
l9_158=texture(sc_OITDepthLow0,l9_151);
l9_157=texture(sc_OITDepthHigh0,l9_151);
}
else
{
l9_159=vec4(0.0);
...
if (l9_156==1)
{
l9_162=texture(sc_OITAlpha1,l9_151);
l9_161=texture(sc_OITDepthLow1,l9_151);
l9_160=texture(sc_OITDepthHigh1,l9_151);
}
else
{
l9_162=l9_159;
...
if (any(notEqual(l9_160,vec4(0.0)))||any(notEqual(l9_161,vec4(0.0))))
{
int l9_163[8]=l9_152;
unpackValues(l9_160.w,l9_156,l9_163);
unpackValues(l9_160.z,l9_156,l9_163);
unpackValues(l9_160.y,l9_156,l9_163);
unpackValues(l9_160.x,l9_156,l9_163);
unpackValues(l9_161.w,l9_156,l9_163);
unpackValues(l9_161.z,l9_156,l9_163);
unpackValues(l9_161.y,l9_156,l9_163);
unpackValues(l9_161.x,l9_156,l9_163);
int l9_172[8]=l9_153;
unpackValues(l9_162.w,l9_156,l9_172);
unpackValues(l9_162.z,l9_156,l9_172);
unpackValues(l9_162.y,l9_156,l9_172);
unpackValues(l9_162.x,l9_156,l9_172);
}
l9_156++;
continue;
}
...
vec4 l9_177=texture(sc_OITFilteredDepthBoundsTexture,l9_151);
vec2 l9_178=l9_177.xy;
int l9_179;
#if (sc_SkinBonesCount>0)
{
l9_179=encodeDepth(((1.0-l9_177.x)*1000.0)+getDepthOrderingEpsilon(),l9_178);
}
#else
{
l9_179=0;
...
#endif
int l9_180=encodeDepth(viewSpaceDepth(),l9_178);
vec4 l9_181;
l9_181=l9_136*l9_136.w;
vec4 l9_182;
int l9_183=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_183<8)
{
int l9_184=l9_152[l9_183];
int l9_185=l9_180-l9_179;
bool l9_186=l9_184<l9_185;
bool l9_187;
if (l9_186)
{
l9_187=l9_152[l9_183]>0;
}
else
{
l9_187=l9_186;
...
if (l9_187)
{
vec3 l9_188=l9_181.xyz*(1.0-(float(l9_153[l9_183])/255.0));
l9_182=vec4(l9_188.x,l9_188.y,l9_188.z,l9_181.w);
}
else
{
l9_182=l9_181;
