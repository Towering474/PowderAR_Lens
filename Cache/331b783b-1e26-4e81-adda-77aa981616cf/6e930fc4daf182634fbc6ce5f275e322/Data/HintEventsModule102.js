 ...
 *
 * // Event Wrapper - takes optional eventName and hintCallback params
 * var myEvent = new eventModule.EventWrapper(hintCallback?); 
 * 
 ...
 */
function EventWrapper(registerCb) {
    /**
     * @private
     * @type {((arg0:T0?, arg1:T1?, arg2:T2?, arg3:T3?)=>void)[]}
     */
    this._callbacks = [];
    this._registerCallback = registerCb;
}
...
EventWrapper.prototype.add = function(callback) {
    if (typeof callback === "function") {
        ...
        if(this._registerCallback){
            this._registerCallback(this._eventName);
        }
        return callback;
    } else {
