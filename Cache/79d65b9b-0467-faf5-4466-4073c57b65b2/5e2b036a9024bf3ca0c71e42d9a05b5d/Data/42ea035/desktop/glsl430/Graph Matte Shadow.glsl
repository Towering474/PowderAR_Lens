...
//texture texture2D opacityTex 0:4:0:22
...
//texture texture2D sc_ShadowTexture 0:19:0:30
//texture texture2DArray intensityTextureArrSC 0:32:0:21
//texture texture2DArray opacityTexArrSC 0:33:0:22
...
//spec_const bool Tweak_N16 37 0
//spec_const bool Tweak_N2 38 0
//spec_const bool Tweak_N25 39 0
//spec_const bool Tweak_N52 40 0
//spec_const bool Tweak_N67 41 0
...
//spec_const int NODE_13_DROPLIST_ITEM 82 0
//spec_const int NODE_27_DROPLIST_ITEM 83 0
//spec_const int NODE_49_DROPLIST_ITEM 84 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 85 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 86 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 87 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 88 -1
...
#if (sc_IsEditor)
{
Color=vec3(sc_UniformConstants.y);
}
#else
{
Color=vec3(1.0);
...
{
vec2 l9_13;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_13,l9_6);
float l9_14;
Node67_Bool_Parameter(l9_14,l9_6);
l9_12=mix(l9_3,l9_13,vec2(l9_14));
}
#else
{
vec2 l9_15;
...
{
vec2 l9_17;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_17,l9_6);
l9_16=((l9_17*Tweak_N50)+Tweak_N51)+(Tweak_N51*(sc_Time.x*Port_Speed_N063));
}
#else
{
vec2 l9_18;
Node59_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_18,l9_6);
l9_16=(l9_18*Tweak_N50)+Tweak_N51;
}
#endif
float l9_19;
#if (Tweak_N25)
...
#endif
l9_15=mix(l9_3,l9_16,vec2(l9_19-0.001));
}
#else
{
l9_15=l9_3;
...
{
bool l9_21=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_22=l9_10.x;
...
float l9_37=l9_36.x;
float l9_38=l9_27;
sc_SoftwareWrapLate(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_21,l9_38);
float l9_39=l9_36.y;
float l9_40=l9_38;
sc_SoftwareWrapLate(l9_39,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_21,l9_40);
float l9_41=l9_40;
vec3 l9_42=sc_SamplingCoordsViewToGlobal(vec2(l9_37,l9_39),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_43=texture(opacityTexArrSC,l9_42,0.0);
vec4 l9_44;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
...
#else
{
bool l9_45=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_46=l9_10.x;
sc_SoftwareWrapEarly(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_47=l9_46;
float l9_48=l9_10.y;
sc_SoftwareWrapEarly(l9_48,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_49=l9_48;
vec2 l9_50;
float l9_51;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_52=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_52=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_53=l9_47;
float l9_54=1.0;
sc_ClampUV(l9_53,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_52,l9_54);
float l9_55=l9_53;
float l9_56=l9_54;
bool l9_57;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_57=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_57=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_58=l9_49;
float l9_59=l9_56;
sc_ClampUV(l9_58,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_57,l9_59);
l9_51=l9_59;
...
#endif
vec2 l9_60=sc_TransformUV(l9_50,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_61=l9_60.x;
float l9_62=l9_51;
sc_SoftwareWrapLate(l9_61,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_45,l9_62);
float l9_63=l9_60.y;
float l9_64=l9_62;
sc_SoftwareWrapLate(l9_63,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_45,l9_64);
float l9_65=l9_64;
vec3 l9_66=sc_SamplingCoordsViewToGlobal(vec2(l9_61,l9_63),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_67=texture(opacityTex,l9_66.xy,0.0);
vec4 l9_68;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_68=mix(opacityTexBorderColor,l9_67,vec4(l9_65));
}
#else
{
l9_68=l9_67;
...
#endif
l9_7=mix(Port_Input0_N006,l9_9,vec3(l9_20.x));
}
#else
{
vec3 l9_69;
Node0_Shadow_Sample(l9_69,l9_6);
l9_7=l9_69;
}
#endif
vec4 l9_70=vec4(l9_7.x,l9_7.y,l9_7.z,vec4(0.0).w);
l9_70.w=Port_Value2_N001;
...
{
l9_75=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_76;
...
{
l9_76=clamp(dot(l9_70.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_77;
...
{
l9_78=(1.0-dot(l9_70.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_79;
...
{
l9_79=(1.0-clamp(dot(l9_70.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_80;
...
{
l9_80=clamp(dot(l9_70.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_81;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_82=clamp(dot(l9_70.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_83;
...
{
l9_83=dot(l9_70.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_84;
...
#endif
vec3 l9_91=mix(l9_88.xyz,definedBlend(l9_88.xyz,l9_70.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_96=vec4(mix(vec3(1.0),l9_70.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_97;
...
{
l9_98=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_98=Port_Value2_N001;
}
#endif
...
vec4 l9_101=sc_OutputMotionVectorIfNeeded(max(l9_99,vec4(0.0)));
