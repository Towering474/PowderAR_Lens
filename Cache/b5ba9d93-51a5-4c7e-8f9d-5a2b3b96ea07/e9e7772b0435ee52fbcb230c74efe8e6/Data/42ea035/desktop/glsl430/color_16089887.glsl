...
#endif
sc_writeFragData0(max(l9_641,vec4(0.0)));
return;
}
vec4 l9_643;
#if (sc_ProjectiveShadowsCaster)
...
vec4 l9_669=sc_OutputMotionVectorIfNeeded(max(l9_667,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_671-0.0039215689)),min(1.0,l9_671+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_673),packValue(l9_673),packValue(l9_673),packValue(l9_673)));
}
#endif
}
#else
...
sc_writeFragData0(l9_670);
}
#endif
}
#else
{
sc_writeFragData0(l9_669);
}
#endif
}
#endif
