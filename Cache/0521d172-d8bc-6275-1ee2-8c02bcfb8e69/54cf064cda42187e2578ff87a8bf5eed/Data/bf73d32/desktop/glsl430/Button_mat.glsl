...
//sampler sampler button_textureSmpSC 0:21
...
//texture texture2D button_texture 0:3:0:21
...
//texture texture2DArray button_textureArrSC 0:32:0:21
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_button_texture 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_button_texture 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 79 -1
//spec_const int button_textureLayout 80 0
...
#define sc_OutputBounds 1
#endif
#ifndef button_textureHasSwappedViews
#define button_textureHasSwappedViews 0
#elif button_textureHasSwappedViews==1
#undef button_textureHasSwappedViews
#define button_textureHasSwappedViews 1
#endif
#ifndef sc_DepthOnly
...
#endif
#ifndef button_textureLayout
#define button_textureLayout 0
#endif
#ifndef SC_USE_UV_TRANSFORM_button_texture
#define SC_USE_UV_TRANSFORM_button_texture 0
#elif SC_USE_UV_TRANSFORM_button_texture==1
#undef SC_USE_UV_TRANSFORM_button_texture
#define SC_USE_UV_TRANSFORM_button_texture 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_button_texture
#define SC_SOFTWARE_WRAP_MODE_U_button_texture -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_button_texture
#define SC_SOFTWARE_WRAP_MODE_V_button_texture -1
#endif
#ifndef SC_USE_UV_MIN_MAX_button_texture
#define SC_USE_UV_MIN_MAX_button_texture 0
#elif SC_USE_UV_MIN_MAX_button_texture==1
#undef SC_USE_UV_MIN_MAX_button_texture
#define SC_USE_UV_MIN_MAX_button_texture 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_button_texture
#define SC_USE_CLAMP_TO_BORDER_button_texture 0
#elif SC_USE_CLAMP_TO_BORDER_button_texture==1
#undef SC_USE_CLAMP_TO_BORDER_button_texture
#define SC_USE_CLAMP_TO_BORDER_button_texture 1
#endif
layout(binding=1,std430) readonly buffer sc_RayTracingCasterVertexBuffer
{
float sc_RayTracingCasterVertices[1];
...
uniform mat3 button_textureTransform;
uniform vec4 button_textureUvMinMax;
uniform vec4 button_textureBorderColor;
uniform int PreviewEnabled;
...
uniform sampler2DArray button_textureArrSC;
...
int button_textureGetStereoViewIndex()
{
int l9_0;
#if (button_textureHasSwappedViews)
{
...
vec2 l9_3=l9_1-Port_Center_N006;
vec2 l9_4=(l9_3*vec2((((button_size-Port_RangeMinA_N010)/((Port_RangeMaxA_N010-Port_RangeMinA_N010)+1e-06))*(Port_RangeMaxB_N010-Port_RangeMinB_N010))+Port_RangeMinB_N010))+Port_Center_N006;
vec4 l9_5;
#if (button_textureLayout==2)
{
bool l9_6=(int(SC_USE_CLAMP_TO_BORDER_button_texture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_button_texture)!=0));
float l9_7=l9_4.x;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).x);
float l9_8=l9_7;
float l9_9=l9_4.y;
sc_SoftwareWrapEarly(l9_9,ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).y);
float l9_10=l9_9;
vec2 l9_11;
float l9_12;
#if (SC_USE_UV_MIN_MAX_button_texture)
{
bool l9_13;
#if (SC_USE_CLAMP_TO_BORDER_button_texture)
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).x==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_button_texture)!=0);
}
#endif
float l9_14=l9_8;
float l9_15=1.0;
sc_ClampUV(l9_14,button_textureUvMinMax.x,button_textureUvMinMax.z,l9_13,l9_15);
float l9_16=l9_14;
float l9_17=l9_15;
bool l9_18;
#if (SC_USE_CLAMP_TO_BORDER_button_texture)
{
l9_18=ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).y==3;
}
#else
{
l9_18=(int(SC_USE_CLAMP_TO_BORDER_button_texture)!=0);
}
#endif
float l9_19=l9_10;
float l9_20=l9_17;
sc_ClampUV(l9_19,button_textureUvMinMax.y,button_textureUvMinMax.w,l9_18,l9_20);
l9_12=l9_20;
...
#endif
vec2 l9_21=sc_TransformUV(l9_11,(int(SC_USE_UV_TRANSFORM_button_texture)!=0),button_textureTransform);
float l9_22=l9_21.x;
float l9_23=l9_12;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).x,l9_6,l9_23);
float l9_24=l9_21.y;
float l9_25=l9_23;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).y,l9_6,l9_25);
float l9_26=l9_25;
vec3 l9_27=sc_SamplingCoordsViewToGlobal(vec2(l9_22,l9_24),button_textureLayout,button_textureGetStereoViewIndex());
vec4 l9_28=texture(button_textureArrSC,l9_27,0.0);
vec4 l9_29;
#if (SC_USE_CLAMP_TO_BORDER_button_texture)
{
l9_29=mix(button_textureBorderColor,l9_28,vec4(l9_26));
}
#else
{
l9_29=l9_28;
...
#else
{
bool l9_30=(int(SC_USE_CLAMP_TO_BORDER_button_texture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_button_texture)!=0));
float l9_31=l9_4.x;
sc_SoftwareWrapEarly(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).x);
float l9_32=l9_31;
float l9_33=l9_4.y;
sc_SoftwareWrapEarly(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).y);
float l9_34=l9_33;
vec2 l9_35;
float l9_36;
#if (SC_USE_UV_MIN_MAX_button_texture)
...
#if (SC_USE_CLAMP_TO_BORDER_button_texture)
{
l9_37=ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).x==3;
}
#else
{
l9_37=(int(SC_USE_CLAMP_TO_BORDER_button_texture)!=0);
}
#endif
float l9_38=l9_32;
float l9_39=1.0;
sc_ClampUV(l9_38,button_textureUvMinMax.x,button_textureUvMinMax.z,l9_37,l9_39);
float l9_40=l9_38;
float l9_41=l9_39;
bool l9_42;
#if (SC_USE_CLAMP_TO_BORDER_button_texture)
{
l9_42=ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).y==3;
}
#else
{
l9_42=(int(SC_USE_CLAMP_TO_BORDER_button_texture)!=0);
}
#endif
float l9_43=l9_34;
float l9_44=l9_41;
sc_ClampUV(l9_43,button_textureUvMinMax.y,button_textureUvMinMax.w,l9_42,l9_44);
l9_36=l9_44;
...
#endif
vec2 l9_45=sc_TransformUV(l9_35,(int(SC_USE_UV_TRANSFORM_button_texture)!=0),button_textureTransform);
float l9_46=l9_45.x;
float l9_47=l9_36;
sc_SoftwareWrapLate(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).x,l9_30,l9_47);
float l9_48=l9_45.y;
float l9_49=l9_47;
sc_SoftwareWrapLate(l9_48,ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).y,l9_30,l9_49);
float l9_50=l9_49;
vec3 l9_51=sc_SamplingCoordsViewToGlobal(vec2(l9_46,l9_48),button_textureLayout,button_textureGetStereoViewIndex());
vec4 l9_52=texture(button_texture,l9_51.xy,0.0);
vec4 l9_53;
#if (SC_USE_CLAMP_TO_BORDER_button_texture)
{
l9_53=mix(button_textureBorderColor,l9_52,vec4(l9_50));
}
#else
{
l9_53=l9_52;
...
#endif
sc_writeFragData0(max(l9_56,vec4(0.0)));
return;
}
vec4 l9_58;
...
{
l9_60=clamp(l9_5.w*2.0,0.0,1.0);
}
#else
{
float l9_61;
...
{
l9_61=clamp(dot(l9_55.xyz,vec3(l9_5.w)),0.0,1.0);
}
#else
{
float l9_62;
...
{
l9_63=(1.0-dot(l9_55.xyz,vec3(0.33333001)))*l9_5.w;
}
#else
{
float l9_64;
...
{
l9_64=(1.0-clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0))*l9_5.w;
}
#else
{
float l9_65;
...
{
l9_65=clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0)*l9_5.w;
}
#else
{
float l9_66;
#if (sc_BlendMode_Add)
{
l9_66=clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_67;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_67=clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0)*l9_5.w;
}
#else
{
float l9_68;
...
{
l9_68=dot(l9_55.xyz,vec3(0.33333001))*l9_5.w;
}
#else
{
float l9_69;
#if (sc_BlendMode_Min)
{
l9_69=1.0-clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_70;
#if (sc_BlendMode_Max)
{
l9_70=clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_70=1.0;
...
#endif
l9_58=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_55.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_59);
}
#else
{
vec4 l9_71;
...
{
l9_75=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_74,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_75=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_74,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_73=l9_75;
}
#endif
vec3 l9_76=mix(l9_73.xyz,definedBlend(l9_73.xyz,l9_55.xyz).xyz,vec3(l9_5.w));
...
#if (sc_Voxelization)
{
l9_78=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_79;
#if (sc_OutputBounds)
{
float l9_80=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_79=vec4(l9_80,1.0-l9_80,1.0,1.0);
}
#else
{
vec4 l9_81;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_81=vec4(mix(vec3(1.0),l9_55.xyz,vec3(l9_5.w)),l9_5.w);
}
#else
{
vec4 l9_82;
...
#endif
l9_82=vec4(l9_55.xyz*l9_83,l9_83);
}
#else
{
l9_82=l9_55;
...
vec4 l9_86=sc_OutputMotionVectorIfNeeded(max(l9_84,vec4(0.0)));
